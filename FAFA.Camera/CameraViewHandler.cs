...
#if IOS || MACCATALYST
using PlatformView = FAFA.Camera.Platforms.iOS.MauiCameraView;
#elif ANDROID
using PlatformView = FAFA.Camera.Platforms.Android.MauiCameraView;
...
public class CameraViewHandler : ViewHandler<CameraView, PlatformView>
{
