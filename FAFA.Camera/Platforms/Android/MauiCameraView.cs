...
public class MauiCameraView: GridLayout
{
    ...
    private void RefreshSnapShot()
    {
        switch (cameraView.AutoSnapShotFormat)
        {
            case ImageFormat.JPEG:
                cameraView.RefreshSnapshot(GetSnapShot(ImageFormat.JPEG, true));
                break;
            case ImageFormat.PNG:
            default:
                cameraView.RefreshSnapshot(GetSnapShot(ImageFormat.PNG, true));
                break;
        }
    }
