...
using FAFA.Camera.Interfaces;
using ImageFormat = FAFA.Camera.Enums.ImageFormat;

namespace FAFA.Camera.Platforms.iOS;

public class MauiCameraView : UIView, IAVCaptureVideoDataOutputSampleBufferDelegate, IAVCaptureFileOutputRecordingDelegate, IAVCapturePhotoCaptureDelegate
{
    ...
    internal async Task<Stream> TakePhotoAsync(Enums.ImageFormat imageFormat)
    {
    ...
    public ImageSource GetSnapShot(Enums.ImageFormat imageFormat, bool auto = false)
    {
